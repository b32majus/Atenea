...
requireText(current.install, "Normal ticket/train choices: `native-balanced`, positive-field-canary candidate `native-v4-heavy`, or eligibility-gated experimental `native-economy`", "installation profile selection");
...
const profileChecker = "tools/check-native-gentle-profile.mjs";
const v4HeavyPromueveCanary = "docs/vnext/NATIVE_V4_HEAVY_PROMUEVE_CANARY_20260925.md";
...
requireText(current.decisions, "## C-068 — V4-heavy has a positive field canary; candidate routing requires proof of the effective child route", "V4-heavy positive canary decision");
...
requireText(executionProfileSelection, "real **read-only child probe**", "effective child routing gate");
requireText(executionProfileSelection, "They do not move the parent/orchestrator model", "pin orchestrator boundary");
requireText(v4HeavyProfile, '"name": "native-v4-heavy"', "V4-heavy desired state");
requireText(v4HeavyProfile, '"status": "positive-field-canary-candidate"', "V4-heavy positive canary status");
requireText(economyProfile, '"name": "native-economy"', "economy desired state");
requireText(profileChecker, 'const PROFILES_KIND = "gentle-pi.agent_model_profiles"', "native profile-store kind guard");
requireText(profileChecker, "ATENEA_PROFILE_PIN_RESOLUTION=PASS", "native pin-resolution oracle");
requireText(v4HeavyPromueveCanary, "Status: **POSITIVE FIELD CANARY / CANDIDATE EVIDENCE**", "PROMueve V4-heavy canary evidence");
requireText(v4HeavyPromueveCanary, "Attempt 0 — invalid routing evidence", "invalid Attempt 0 exclusion");
requireText(v4HeavyPromueveCanary, "WU-A 172fb2bf9789c18e1866a0dbc9071b07c5e81716", "PROMueve WU-A field evidence");
requireText(v4HeavyPromueveCanary, "WU-B 17f9db676e810575bdeccc9b4d20c0c9d8ea07b5", "PROMueve WU-B field evidence");
...
requireText(compat, "Profile store / pin resolution incident — 2026-09-25", "profile-store incident compatibility seam");
